...
exports.conversation = class conversation extends BaseAction {
   ...
   */
    elements = {
        ...
        msg : 'div[aria-label="Messenger"] div[data-testid="mwthreadlist-item-open"] > div > div:nth-child(1) > a',
    ...
    async openBrowserWithURL() {
        await this.openBrowser(global.BASE_URL_FB);
        await this.wait(3);
    }
    ...
    async secondTab() {
        await this.openNewTab(global.BASE_URL_FB)
    }
